...
| --- | --- | --- |
| `<set-slug>` | Set-Id aus dem Wurzel-`manifest.yaml` (z. B. `welpen-grundkurs-from-de`) oder der Ordnername des Set-Pfads (z. B. `welpen-grundkurs` für `sets/de/welpen-grundkurs`) | Pflicht |
...
make export ARGS="welpen-grundkurs --format json --out /tmp/review.json"

# Grosses Set: in Teile von je hoechstens 3 Lektionen aufteilen, fuer eine
# KI mit begrenztem Kontextfenster (welpen-grundkurs hat 4 Lektionen, also
# ergibt das einen 3+1-Split)
make export ARGS="welpen-grundkurs --split-size 3"
# -> exports/welpen-grundkurs-de-<timestamp>-part01-of-02.yaml, part02-of-02
```
